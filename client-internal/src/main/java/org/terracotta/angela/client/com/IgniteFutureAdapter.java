 ...
 */
package org.terracotta.angela.client.com;
...
public class IgniteFutureAdapter<V> implements Future<V> {
  ...
  public IgniteFutureAdapter(IgniteFuture<V> igniteFuture) {
  ...
  public static RemoteExecutionException lookForRemoteExecutionException(Throwable t) {
